...
We also were inspired by the paper ["Integer-Only Approximated MFCC for Ultra-Low Power Audio NN Processing on Multi-Core MCUs" - https://doi.org/10.1109/AICAS51828.2021.9458491](https://doi.org/10.1109/AICAS51828.2021.9458491) with LP16 to develop the MFCC, as it provides a methodology for implementing efficient MFCC extraction using integer arithmetic. This approach is well-suited for ultra-low power audio processing on resource-constrained devices, ensuring energy efficiency and performance optimization.
